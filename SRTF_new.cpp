...
int n = 0, ideal_no = 0, ideal_time = 0, arrival[100], burst[100], index_arrival[100], aux[100], actual_index[100], ac[100], bc[100], gantt[100];
void heart (int*, int*);
